...
\begin{document}
	\section{ViewModel}
		...
		\subsection{- ConnectionPageVM}
			...
			Diese Klasse wurde komplett entfernt. Der Nutzer wird bei Betätigung des \_connectionButtons der MainPage stattdessen zu den Settings des Smartphones geleitet um dort sich mit einem Earable über Bluetooth-Classic zu verbinden, sollte noch keine Verbindung bestehen. Andernfalls wird sich bei Betätigung des \_connectionButtons der MainPage direkt mit den in den Settings verbundenen Earables über Bluetooth-Low-Energy verbunden.
