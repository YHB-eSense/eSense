...
\begin{itemize}
\changed{ Ist jetzt async, das Senden des Befehls an die API lange dauert. \sign{public async void TogglePause()}}
\changed{ Ist jetzt async, das Senden des Befehls an die API lange dauert. \sign{public async void PlayTrack(AudioTrack track)}}
