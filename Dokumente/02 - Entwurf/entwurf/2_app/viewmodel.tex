...
\code{public class AddSongPageVM} \newline
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\code{public class AudioLibPageVM} \newline
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\code{public class AudioPlayerPageVM} \newline
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\code{public class ConnectionPageVM} \newline
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
\code{public class SettingsPageVM} \newline
...
\end{minipage}
\begin{minipage}{0.55\textwidth}
\code{public class NavigationHandler} \newline
